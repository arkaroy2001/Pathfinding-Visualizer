...
class Graph():
    ...
    def start_search(self, grid, SCREEN):
        counter = 0
        ...
        while not pq.empty():
            ...
            if top[2] == end_coordinate and nodeMap[top[2]]["done"]==True:
                ...
                while present[1] != start_coordinate:
                    ...
                    present = (self.edge_weight(nodeMap[present[1]]["prev"],present[1]),nodeMap[present[1]]["prev"],present[1])
